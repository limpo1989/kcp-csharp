...
// + Maximum RTT reduce three times vs tcp.#include "stdafx.h"
...
// KCP BASIC
//=====================================================================
const IUINT32 IKCP_RTO_NDL = 30;		// no delay min rto nodelay情况下的rto,可以设的更小
...
const IUINT32 IKCP_INTERVAL = 5; //100
...
IUINT32 ikcp_check(const ikcpcb *kcp, IUINT32 current)
{
	...
	//if (_itimediff(current, ts_flush) >= 1000 ||
	//	_itimediff(current, ts_flush) < -1000) {
	//	ts_flush = current;
	//}
